...
| `terraform plan -out tfplan` | `terraform plan` calcula o que será criado, alterado ou destruído. `-out tfplan` salva esse plano num arquivo chamado `tfplan`. Depois, aplica-se exatamente esse plano com `terraform apply tfplan`. |
